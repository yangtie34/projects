...
drop table tl_card_pay_stu_month;
create table tl_card_pay_stu_month ( 

  YEAR_MONTH      date,
  HOUR_           VARCHAR2(100),
  PAY_MONEY       VARCHAR2(100),
  PAY_COUNT       VARCHAR2(100),
  CARD_DEPT_ID    VARCHAR2(100),
  CARD_DEPT_NAME  VARCHAR2(100),
  CARD_DEPT_PID   VARCHAR2(100),
  CARD_DEPT_PNAME VARCHAR2(100),
