...
public class CheckLoginInterceptor extends AbstractInterceptor {
	...
	public String intercept(ActionInvocation invocation) throws Exception {
		...
		if (invocation.getAction() instanceof LoginAction
				|| invocation.getAction() instanceof PermissAction
		...
		UserInfo user = (UserInfo) session.get(SysConstants.SESSION_USERINFO);
		
//		CurrentUserMenuUtil.setThreadUserMenu(null, 1001000003429658l);
//		
//		User u = (User) session.get(SysConstants.SESSION_USER);
//		System.out.println(u.getCurrentLoginname()+"first");
//		CurrentUserMenuUtil.setThreadUserMenu(1001000003430459l, 1001000003429658l);
//		System.out.println(u.getCurrentLoginname()+"second");
		if (user == null) {
