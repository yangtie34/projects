...
import com.eyun.jybStorageScan.product.dao.StorageOutRecDao;
...
public class StorageOutRecDaoImpl implements StorageOutRecDao {
    ...
    public boolean IsExist(String recNumber) {
        ...
        String sqlExists="Select 1 from storage_StorageOutRec where RecNumber="+ SqlStringUtils.GetQuotedString(recNumber);
    ...
    public StorageOutRec getStorageOutRecByRecNumber(String RecNumber) {
        String sqlSelect="Select * from storage_StorageOutRec where RecNumber="+SqlStringUtils.GetQuotedString(RecNumber);
    ...
    public String addStorageOutRec(StorageOutRec mo) {
        ...
        String sqlInsert=SqlStringUtils.GetConstructionInsert("storage_StorageOutRec",map);
    ...
    public boolean updateState(String RecNumber, int state) {
        ...
        String sqlUpdate=SqlStringUtils.GetConstructionUpdate("storage_StorageOutRec",map,where);
