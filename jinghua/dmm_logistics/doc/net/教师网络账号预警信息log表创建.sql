insert into tl_net_tea_warn  
select to_date('2015-12','yyyy_mm') year_month,a.people_id,a.on_ip,a.ON_WORK_NUM,a.OUT_WORK_NUM,
nvl(b.num,0) stu_num,a.people_name,a.sex_code ,
a.sex_name ,a.dept_id,a.dept_name  from (
select on_ip, u.people_id, tea.name_ people_name,
       tea.sex_code, tc.name_ sex_name,  
       tea.dept_id, cd.name_ dept_name,
       SUM(CASE WHEN SUBSTR(T.ON_TIME, 12, 2) >= 8 AND
                  SUBSTR(T.ON_TIME, 12, 2) < 20 AND
  ...
  where substr(t.on_time,0,7) = '2015-12' 
...
drop table tl_net_tea_warn;
create table tl_net_tea_warn ( 
	YEAR_MONTH    DATE, 		--年月
  PEOPLE_ID		  VARCHAR2(100),
	ON_IP			    VARCHAR2(100),
	ON_WORK_NUM		VARCHAR2(100),
	OUT_WORK_NUM	VARCHAR2(100),
	STU_NUM			  VARCHAR2(100),
