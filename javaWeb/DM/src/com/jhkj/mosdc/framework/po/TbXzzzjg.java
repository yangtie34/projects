...
/**
 * TbXzzzjg entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TB_XZZZJG")
public class TbXzzzjg implements java.io.Serializable {
	...
	public TbXzzzjg(Long id, String dm, String mc, Long fjdId, Long cc,
