...
@Entity
@Table(name="T_STU_SCORE_RESULT_TEACHER")
public class TStuScoreResultTeacher implements Serializable{
	...
	public TStuScoreResultTeacher() {
		super();
	}
	
	public TStuScoreResultTeacher(String id, String tea_id, String school_year, String term_code, Double gpa_avg, Double gpa_middle,
	...
	public TStuScoreResultTeacher( String tea_id, String school_year, String term_code, Double gpa_avg, Double gpa_middle,
			Double gpa_mode,Double gpa_fc,Double gpa_bzc,Double better,Double fail,Double rebuild,Double under,Double score_avg,
			Double score_middle,Double score_mode,Double score_fc,Double score_bzc,Double gpa_before,int smart_count,Double smart_scale) {
		super();
		this.tea_id = tea_id;
