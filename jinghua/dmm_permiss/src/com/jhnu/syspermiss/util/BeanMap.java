        ...
        for (int i = 0; i< propertyDescriptors.length; i++) {
            ...
            if (map.containsKey(propertyName)) {
                ...
                if(clotype.equalsIgnoreCase("Short")) {
                 ...
                 String typ=descriptor.getWriteMethod().getParameterTypes()[0].getSimpleName();
                 if(typ.equalsIgnoreCase("String")){
                	 args=value+"";
				 }else if(typ.equalsIgnoreCase("Short")){
                	 args=new Short(value+"");
				 }else if(typ.equalsIgnoreCase("Integer")){
                	 args=Integer.parseInt(value+"");
				 }else if(typ.equalsIgnoreCase("Long")){
