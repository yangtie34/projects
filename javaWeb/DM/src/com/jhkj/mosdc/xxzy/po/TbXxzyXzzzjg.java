 ...
 */
@Entity
@Table(name = "TB_XZZZJG")
public class TbXxzyXzzzjg implements java.io.Serializable {
	...
	public TbXxzyXzzzjg(Long id, String dm, String mc, Long fjdId, Long cc,
			String cclx, Long sfyzjd, Long sfky, String cjsj, String cjr,
			String xgsj, String xgr, String qxm, Long pxh) {
		super();
		this.id = id;
		this.dm = dm;
		this.mc = mc;
