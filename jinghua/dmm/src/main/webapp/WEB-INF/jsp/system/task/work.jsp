          ...
          <div class="quanxian-tools">
            ...
            <div class="quanxian-block-search">
              <div class="quanxian-in-search"><span class="quanxian-fposition">
                <input class="quanxian-search-t" type="text" placeholder="计划名称 模糊匹配" ng-keyup="myKeyup($event)" ng-model="Work.name_">
        ...
        <table class="quanxian-sub-table" width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tbody>
				<tr ng-repeat="item in vm.items" class="quanxian-bg-hover">
					...
					<td><button type="button"  class="quanxian-btn-table" ng-click=""> <a href="${ctx}/system/task/workVerify/{{item.id}}" target="_blank">验证步骤 </a> </button></td>
				</tr>
			</tbody>
		</table>
        <!--表格-->
