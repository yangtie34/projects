...
@Controller
@RequestMapping("pmsNewStu")
public class NewStuPmsCtol {
	@Resource
	...
	public Map<String, Object> getStuList(String param,String page, String values, String fields) {
		return newStuService.getStuDetail(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page),JSONObject.parseObject(values, HashMap.class), JSONObject.parseArray(fields, String.class));
	}
...
//		response.setContentType("application/x-execl"); 
		...
		List<Map<String, Object>> list = newStuService.getStuDetailList(AdvancedUtil.converAdvancedList(param), JSONObject.parseObject(values, HashMap.class), JSONObject.parseArray(fields, String.class));
