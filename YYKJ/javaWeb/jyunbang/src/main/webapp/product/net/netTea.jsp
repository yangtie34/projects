...
<body ng-controller="netTeaController">
<div id="wrapper">
<%-- <jsp:include page="../../product/left.jsp"></jsp:include> --%>
 <script type="text/javascript" src="${ctx }/product/net/js/netTea.js"></script>   
  <div class="content" >
  <div class="xscz-head content_head">
    <h3 class="xscz-fff">教师上网分析</h3>
    <p class="xscz-default">对教师上网进行分析。</p>
  </div>
      	...
      	<div class="row  row-20 clearfix">
            ...
            <div ng-class="ulcla[1]">
                ...
                .chevron {
                    ...
                    <span ng-repeat="item in fllx"ng-class="fllxcode==item.code?active:'normal'" ng-click="fllxClick(item.code);"><a href="">按{{item.name}}</a></span>
                 <a class="glyphicon glyphicon-chevron-left chevron" style="float:left"ng-show="ulindex[0]==false" ng-click="ulindexclick(-1);"title="左滑"></a>
                  <a class="glyphicon glyphicon-chevron-right chevron" ng-show="ulindex[ulindex.length-1]==false" ng-click="ulindexclick(1);"title="右滑"></a>
              </div>
            </div>
        </div>
        <div class="row row-20 text-center clearfix">
        <div ng-repeat="(key,value) in vm" ng-show="key=='all'||key==fllxcode">
  			<ul class="has-btm-border no-mar-btm" ng-class="ulcla[0]" ng-class="key!='all'&&$index==0?'border-r-solid':''" ng-repeat="(k,v) in value"  ng-show="key=='all'||ulindex[$index]">
            	<li class="tit-row" style="border-bottom: none;">
                	<span class="tit-40" ><img ng-src="${images}/gender-{{ico_title[key][k].ico}}.png" alt=""ng-show="ico_title[key][k].ico!='null'"></span>
                ...
                <li style="border-bottom: none;">
                	<div class="shw-pannel">
                    	...
                    	<!-- <a href="" class="shw-clock" ng-click="qushiClick(key,k,'all');"title="趋势统计"></a> -->
                    	</div>
