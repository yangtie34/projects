...
@Entity
@Table(name = "TB_JZGXX")
public class TbXxzyJzgxx implements java.io.Serializable {
  /**
	*创建时间
    */ 
	 private String cjsj;  
...
//	 private Long bzlbId;  
	...
	*/ 
	...
	/** default constructor */
	public TbXxzyJzgxx(String cjsj, String xgsj, Long yxId, String cjrq,
			...
			Long xyjxkId, Long xkId, Long xkId3, Long gwlId, Long yrxsId,
			...
			Long dywyyzId, Long zyjszcId, String htqx, Long jxzzjgId,Long rylbId,Long sfky,Long sfssjs) {
		super();
		this.cjsj = cjsj;
		this.xgsj = xgsj;
		this.yxId = yxId;
	...
	@Column(name = "SFSSJS", length = 1)
	public void setSfssjs(Long sfssjs) {
		this.sfssjs = sfssjs;
	}
	public Long getSfssjs() {
		return sfssjs;
	}
}