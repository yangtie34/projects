...
<body ng-controller="ReadRankController">
<div id="wrapper">
<%-- <jsp:include page="../../product/left.jsp"></jsp:include> --%>
 <script type="text/javascript" src="${ctx }/product/book/js/ReadRank.js"></script>    
    
        <div class="content" >
       <div class="xscz-head content_head">
                <h3 class="xscz-fff">图书借阅排名</h3> 
                <p class="xscz-default">对图书借阅的日常排名和年度人员排名进行分析。</p> 
            </div>
            	...
            	<div class="jieyuepm_section">
                    	<div class="richangpm">
                        	<div class="fr">
                                ...
                                <div ng-class="ndrypm?'xuanzhong_no':'xuanzhong'" ng-click="ndrypm=false;resetTime();">
                                	<a href=""><div id="liub"><h4>日常排名</h4></div></a>
                                </div>
                        ...
                        <div class="niandupm">
                        	<div class="fl">
                                 <img src="${images}/books_images/border_blue_top.png" class="img-top" ng-show="ndrypm">
                                <img src="${images}/border_15.png" class="img-top" ng-show="!ndrypm">
                                <div ng-class="!ndrypm?'xuanzhong_no':'xuanzhong'" ng-click="ndrypm=true">
                                	<a href=""><div id="liub"><h4>年度人员排名</h4></div></a>
                                </div>
                                   <img src="${images}/books_images/border_blue_bottom.png" class="img-top" ng-show="ndrypm">
                                <img src="${images}/border_18.png" class="img-top" ng-show="!ndrypm">
                                 <p class="triangle_down" ng-show="ndrypm"></p>
                             ...
                             <thead>
                                   ...
                                   <tbody>
                                      <tr class="tab_dashed" ng-repeat="item in vm.items[0]">
                                         ...
                                         <td>{{item.NAME}}</td>
                                         <td>{{item.OFNAME}}</td>
                                         <td><a href="" class="colorr" ng-click="getxqById(item.NO_,null,null,12);getxqById">{{item.BORROW_NUM}}</a></td>
                                         <td><a href="" class="colorr"  ng-click="getxqById(item.NO_,null,null,13);">{{item.TOPNUM}}</a></td>
...
<!--分页-->
                ...
                <div class="fenbu pdbtm_box">
                	<div class="t">
            			<h5>{{type1=='stu'?'学生':type1=='tea'?'教师':'书籍'}}借阅分布情况</h5>
                	</div>
                     <div class="fenbu_con rylxfb_con" ng-show="type1!='book'">
                    	<div class="col-md-4" style="width:50%">
                        	<h4>学历对比
                        		<span tool-tip placement="top" hide-icon="true" class="icon-time" ng-click="qushiClick(2);">
                      ...
                      <!--   	<span class="icon-time" ng-click="qushiClick(2);"></span> -->
                        ...
                        <div class="col-md-4 fenbu_con_m" style="width:50%;border-right: none;">
                        	<h4>性别对比
                        	<span tool-tip placement="top" hide-icon="true" class="icon-time" ng-click="qushiClick(4);">
									<div style="width: 160px">点击此处查看趋势</div>
								</span>
                       ...
                       <%--  <div class="col-md-4">
                        	<h4>{{type1=='tea'?'职称':'年级'}}对比<span class="icon-time" ng-click="qushiClick(6);"></span></h4>
                    ...
                    <h4>所属{{type1=='book'?'类型':deptlname}}对比
                    <span tool-tip placement="top" hide-icon="true" class="icon-time" ng-click="qushiClick(8);">
									<div style="width: 160px">点击此处查看趋势</div>
								</span>
                   <!--  <span class="icon-time" ng-click="qushiClick(8);"></span> -->
                    </h4>
                	...
                	<div class="ndhj">
                        ...
                        <div class="ndhj_con">
                            <div ng-repeat="item in vm.items[9]" ng-class="item.RANK_==1?'guanjun':item.RANK_==2?'yajun':'jijun fr'">
                            	<div class="huoj_head">
                                	<img src="${images}/user-{{item.SEX_NAME=='男'?'boy':'girl'}}.jpg" width="105" height="105" class="img-circle fl img-top">
                                    <div class="fl mz">
                                        <h4>{{item.NAME_}}<%-- <img src="${images}/books_images/{{item.SEX_NAME=='男'?'nan':'nv'}}.png"> --%></h4>
                                        <h5>{{item.NO_}}</h5>
                                    </div>
                                        	...
                                        	<table>
                                            	<tbody>  
                                                    <tr class="tr_border">  
                                                      <td class="td_border">
                                                      	<p>本年借书</p>
                                                        <p class="p_td"><a href="" class="colorr" ng-click="getxqById(item.NO_,'year',null,12);">{{item.YEARNUM}}</a>本</p>
                                                      </td>  
                                                      <td>
                                                      	<p>历史借书</p>
                                                        <p class="p_td"><a href="" class="colorr"ng-click="getxqById(item.NO_,null,null,18);">{{item.HISTORYNUM}}</a>本</p>
                                                      </td>  
                                                    </tr> 
                                                    <tr>  
                                                      <td class="td_border">
                                                      	<p class="p_td">本年月度上榜</p>
                                                        <p><a href="" class="colorr"ng-click="getxqById(item.NO_,'year',null,13);">{{item.TOPNUM}}</a>次</p>
                                                      </td>  
                                                      <td>
                                                      	<p class="p_td">历史月度上榜</p>
                                                        <p><a href="" class="colorr"ng-click="getxqById(item.NO_,null,null,19);">{{item.HISTORYTOP}}</a>次</p>
                                                      </td>  
                                                    </tr> 
                                                </tbody> 
                                            </table>
                     ...
                     <div id="jidudiv"class="jidugj">
                     	<div ng-repeat="item in vm.items[10]" ng-class="$index==3?'last_border':''">
                        	<div class="jidugj_l col-md-5">
                                ...
                                <div class="fl name">
                                    <img src="${images}/user-{{item.SEX_NAME=='男'?'boy':'girl'}}.jpg" width="90" height="90" class="img-circle img-top">
                                    <h4>{{item.NAME_}} <%-- <img src="${images}/books_images/{{item.SEX_NAME=='男'?'nan':'nv'}}.png" class="img-top"> --%> </h4>
                                </div>
                                <div class="fl">
                                	<ul>
                                    	<li>{{item.NO_}}</li>
                            ...
                            <div class="jidugj_m col-md-4">
                                ...
                                <div class="jidugj_m_bottom">
                                	<ul>
                                        <li>本季</li>
                                        <li><a href="" class="colorr" ng-click="getxqById(item.NO_,'quarter',item.QUARTERNAME,12);">{{item.QUARTERNUM}}</a>本</li>
                                    </ul>
                                    <ul>
                                        <li>本年</li>
                                        <li><a href="" class="colorr" ng-click="getxqById(item.NO_,'year',item.QUARTERNAME,12);">{{item.YEARNUM}}</a>本</li>
                                    </ul>
                                    <ul>
                                        <li>历史</li>
                                        <li><a href="" class="colorr" ng-click="getxqById(item.NO_,null,null,18);">{{item.HISTORYNUM}}</a>本</li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="jidugj_r col-md-3">
                            	<div class="jidugj_m_top"><h5><img src="${images}/books_images/huangguan.jpg" class="img-top">季度上榜</h5></div>
                                <div class="jidugj_m_bottom">
                                	<ul>
                                        <li>本季</li>
                                        <li><a href="" class="colorr" ng-click="getxqById(item.NO_,'quarter',item.QUARTERNAME,13);">{{item.TOPNUM}}</a>次</li>
                                    </ul>
                                    <ul>
                                        <li>历史</li>
                                        <li><a href="" class="colorr" ng-click="getxqById(item.NO_,null,null,19);">{{item.HISTORYTOP}}</a>次</li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        ...
                        <div id="zkygjdiv" ng-repeat="item in vm.items[11]" ng-class="$index==3?'last_border':''">
                            ...
                            <div class="jidugj_m col-md-4">
                                ...
                                <div class="jidugj_m_bottom">
                                	<ul>
                                        <li>本月</li>
                                        <li><a href="" class="colorr"ng-click="getxqById(item.NO_,'month',item.MONTH_,12);">{{item.MONTHNUM}}</a>本</li>
                                    </ul>
                                    <ul>
                                        <li>本年</li>
                                        <li><a href="" class="colorr"ng-click="getxqById(item.NO_,'year',null,12);">{{item.YEARNUM}}</a>本</li>
                                    </ul>
                                    <ul>
                                        <li>历史</li>
                                        <li><a href="" class="colorr"ng-click="getxqById(item.NO_,null,null,18);">{{item.HISTORYNUM}}</a>本</li>
                            ...
                            <div class="jidugj_r col-md-3">
                            	<div class="jidugj_m_top"><h5><img src="${images}/books_images/huangguan.jpg" class="img-top">月度上榜TOP10</h5></div>
                                <div class="jidugj_m_bottom">
                                	<ul>
                                        <li>本年</li>
                                        <li><a href="" class="colorr"ng-click="getxqById(item.NO_,'month',item.MONTH_,13);">{{item.TOPNUM}}</a>次</li>
                                    </ul>
                                    <ul>
                                        <li>历史</li>
                                        <li><a href="" class="colorr"ng-click="getxqById(item.NO_,null,null,19);">{{item.HISTORYTOP}}</a>次</li>
