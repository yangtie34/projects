...
<head>
<meta charset="UTF-8">
<base href="<%=root%>/student/bind/bind.jsp"/>
<jsp:include page="../../static/base.jsp"></jsp:include>
<title>学生微信绑定中心</title>
<script type="text/javascript" src="js/controller.js"></script>
<script type="text/javascript" src="js/service.js"></script>
</head>
<body ng-controller="controller">
	<p ><h3 class="text-center">学生个人信息绑定</h3></p>
	<div class="center-block col-md-6"style="float: none;padding: 0px;">
		...
		<form name="bindform" class="form-horizontal">
		  <div class="form-group">
		    <div class="col-md-12">
		        ...
		        <input type="text" class="form-control" name="username" placeholder="学号" ng-model="user.username" required>
		    </div>
		  </div>
		  <div class="form-group">
		    <div class="col-md-12">
		  ...
		  <div ng-show="(!bindform.username.$valid && !bindform.username.$pristine) || (!bindform.password.$valid && !bindform.password.$pristine)" class="form-group">
		    <div class="col-md-12">
		     	<div class="bg-danger text-danger small" style="padding:10px 15px;">
					<div ng-show="!bindform.username.$valid && !bindform.username.$pristine" >* 学号不能为空</div>
