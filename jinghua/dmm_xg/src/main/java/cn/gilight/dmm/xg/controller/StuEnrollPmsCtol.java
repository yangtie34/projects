...
@Controller
@RequestMapping("pmsStuEnroll")
public class StuEnrollPmsCtol {
	@Resource
	...
	public Map<String, Object> getStuDetail(String param,String page, String values, String fields) {
		return stuEnrollService.getStuDetail(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page),JSONObject.parseObject(values, HashMap.class), JSONObject.parseArray(fields, String.class));
	}
...
//		response.setContentType("application/x-execl"); 
		...
		List<Map<String, Object>> list = stuEnrollService.getStuDetailList(AdvancedUtil.converAdvancedList(param), JSONObject.parseObject(values, HashMap.class), JSONObject.parseArray(fields, String.class));
