...
angular.module('custom').factory('TreeData', function() {
  /**
  ...
  function TreeData(tree, cbIsSame) {
     ...
     * @private
     */
    this._updateParents = function(children, item) {
      _.each(children, function(subItem) {
    ...
    this._find = function(children, item) {
      if (!children)
        return null;
      // 在子节点中查找
