...
<script type="text/javascript" src="product/stuHighCost/controller.js"></script>
...
<script type="text/javascript" src="product/stuHighCost/constant.js"></script>
        ...
        <div class="xuegong-zhuti-content-main">
            ...
            <section>
            	<div class="xuegong-zhuti-content-main-tit">
                    ...
                    <p  class="p-marg-left">第{{data.month}}月高消费<span>
                    <a href="" ng-click="data.lastmonthcount==0||weekDetailClick('lastmonth','高消费（第'+data.month+'月）学生名单')"ng-class="{'text-pink':data.lastmonthcount !=0,'text-pink cursor-default':data.lastmonthcount==0 }"><b>{{data.lastmonthcount}}</b></a>
                    ...
                    <span class="question-icon pull-right" style="margin-top:8px" ng-mouseover="data.tip_show=true" ng-mouseleave="data.tip_show=false">
		                        ...
		                        <div class="question-area-box question-area-box-top" ng-show="data.tip_show">
		                            <div class="question-area">
		                                ...
		                                <p><b>高消费计算规则：</b></p>
		                        		<p>上学期所有学生的消费经过算法计算出每天的高消费标准值是{{data.standard}}元，</p>
		                        		<p> 该月内日均消费高于{{data.standard}}元就是高消费。</p>
		                        		<p ng-if="data.standardMc != null"> <b>算法：</b>{{data.standardMc}}</p>
		                        		<p> 注：高消费目前只计算{{data.xflx}}消费，表格数据按月统计。</p>
                	...
                	<table class="table table-bordered xuegong-zhuti-table dixiaofei-table">
                        ...
                        <tbody>
                        	<tr ng-repeat = "x in data.deptlist">
                                ...
                                <td><a href="" ng-class="{'text-blue':x.count>0,'text-blue cursor-default':x.count==0}" ng-click = "x.count==0||weekDetailClick('','高消费（'+x.name+'）学生名单',x.id)">{{x.count}}</a></td>
                 ...
                 <span class="question-icon pull-right" style="margin-top:8px" ng-mouseover="data.tip_show=true" ng-mouseleave="data.tip_show=false">
		                        ...
		                        <div class="question-area-box question-area-box-top" ng-show="data.tip_show">
		                            <div class="question-area">
		                                <img src="static/resource/images/xues-gognzuozhe/question-k.png">
		                        		<p> 统计该学期高消费学生；</p>
		                        		<!-- <p ng-if="data.yearlist.length >0"> 切换近几年时，统计这些学年所有学期（各学期高消费标准不同）的高消费学生，一个学生可能多个学期都是高消费。</p> -->
		                            </div>
		                        </div>
		                    </span> 
                <div class="clearfix"></div>
             ...
             <section class="xuegong-neirong no-bottom">
            	<div class="xuegong-dixiaofei row">
                	<div class="xuegong-dixiaofei-fenbu pull-left" >
                    	<div class="biaoti"><span ng-if="mealShow" class="text-blue">高消费分布</span><span ng-if="!mealShow"class="text-blue">各餐别高消费变化<br><small class=" text-black">（展示近几学期高消费变化，不随学期选择变化）</small></span><a href="" ng-click="mealSwich()"><span class="pull-right time-img"></span></a></div>
                    ...
                    <div class="xuegong-dixiaofei-xuesheng-fenbu pull-left">
                    	<div class="biaoti text-blue"><span ng-if="gradeShow" class="text-blue">高消费学生分布</span><span ng-if="!gradeShow" class="text-blue">各年级、性别高消费变化<br><small class=" text-black">（展示近几学期高消费变化，不随学期选择变化）</small></span><a href="" ng-click="gradeSwich()"><span class="pull-right time-img"></span></a></div>
                        <div class="img-box">
       ...
       <!--                      <div class="img-box-r pull-left" style="height: 350px"ng-if="gradeShow&&data.isYear" echart config="data.distribute.yearSexCfg"></div> -->
                ...
                <div class="xuegong-dixiaofei dixiaofei-xs row">
                	<div class="dixiaofei-xs-con">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                              <div id= "Xg_stuHighCost_subsidy" style="height:{{gd}}px"class="img-box" ng-if="loanShow&&!data.isYear" ></div> 
                             <div id= "Xg_stuHighCost_subsidy"style="height:{{gd}}px" class="img-box" ng-if="!loanShow" echart config="data.history.subsidyHistoryCfg"></div> 
                            <div id= "Xg_stuHighCost_subsidy" style="height:{{gd}}px"class="img-box"  ng-if="loanShow&&data.isYear" ></div> 
                            <!-- <div id= "Xg_stuHighCost_subsidy" style="height:{{gd}}px"class="img-box" ng-if="loanShow&&!data.isYear" ></div> 
                             <div id= "Xg_stuHighCost_subsidy"style="height:{{gd}}px" class="img-box" ng-if="!loanShow" ></div> 
                            <div id= "Xg_stuHighCost_subsidy" style="height:{{gd}}px"class="img-box"  ng-if="loanShow&&data.isYear" ></div>-->
                                <p ng-if="loanShow==true">获助学金学生中有{{data.subsidyscale}}%（<a href="" ng-class="{'text-green': !data.isYear,'text-green cursor-default':(data.isYear|| data.subsidyscale ==0)}" ng-click = "(data.isYear|| data.subsidyscale ==0)||loanClick('subsidy','高消费（获助学金）学生名单','3')"><b >{{data.subsidycount}}{{!data.isYear?'人':'人次'}}</b></a>）是高消费学生</p>
                            </div>
                             <div class="col-md-4">
                        <div  id= "Xg_stuHighCost_loan"style="height:{{gd}}px"class="img-box" ng-if="loanShow&&!data.isYear" ></div>
                            <div id= "Xg_stuHighCost_loan" style="height:{{gd}}px"class="img-box" ng-if="!loanShow" echart config="data.history.loanHistoryCfg"></div>
                            <div id= "Xg_stuHighCost_loan" style="height:{{gd}}px"class="img-box"  ng-if="loanShow&&data.isYear" ></div> 
                         <!--   <div  id= "Xg_stuHighCost_loan"style="height:{{gd}}px"class="img-box" ng-if="loanShow&&!data.isYear"></div>
                            <div id= "Xg_stuHighCost_loan" style="height:{{gd}}px"class="img-box" ng-if="!loanShow" ></div>
                            <div id= "Xg_stuHighCost_loan" style="height:{{gd}}px"class="img-box"  ng-if="loanShow&&data.isYear"></div>--> 
                                <p ng-if="loanShow==true">获助学贷款学生中有{{data.loanscale}}%（<a href="" ng-class="{'text-green': !data.isYear,'text-green cursor-default':(data.isYear|| data.loanscale ==0)}" ng-click = "(data.isYear|| data.loanscale ==0)||loanClick('loan','高消费（获助学贷款）学生名单','3')"><b >{{data.loancount}}{{!data.isYear?'人':'人次'}}</b></a>）是高消费学生</p>
                            </div>
                            <div class="col-md-4">
                            <div id= "Xg_stuHighCost_jm" style="height:{{gd}}px"class="img-box" ng-if="loanShow&&!data.isYear" ></div>
                            <div id= "Xg_stuHighCost_jm" style="height:{{gd}}px"class="img-box" ng-if="!loanShow" echart config="data.history.jmHistoryCfg"></div>
                            <div id= "Xg_stuHighCost_jm" style="height:{{gd}}px"class="img-box"  ng-if="loanShow&&data.isYear" ></div>
                            <!--  <div id= "Xg_stuHighCost_jm" style="height:{{gd}}px"class="img-box" ng-if="loanShow&&!data.isYear"></div>
                            <div id= "Xg_stuHighCost_jm" style="height:{{gd}}px"class="img-box" ng-if="!loanShow" ></div>
                            <div id= "Xg_stuHighCost_jm" style="height:{{gd}}px"class="img-box"  ng-if="loanShow&&data.isYear" ></div> -->
                                <p ng-if="loanShow==true">获学费减免学生中有{{data.jmscale}}%（<a href="" ng-class="{'text-green': !data.isYear,'text-green cursor-default':(data.isYear|| data.jmscale ==0)}" ng-click = "(data.isYear|| data.jmscale ==0)||loanClick('jm','高消费（获学费减免）学生名单','3')"><b>{{data.jmcount}}{{!data.isYear?'人':'人次'}}</b></a>）是高消费学生</p>
                            </div>
                        </div>
                    </div>
                </div>
                 <div class="xuegong-bottom-section">
                	<div class="biaoti text-blue"><span class="text-blue">各院系高消费分布与占比</span></div>
