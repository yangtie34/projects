 ...
 *
 */
public interface BookOutTimeDayBookTopDao {
	 ...
	 */
	public Page getOutTimeDayTopByBook(int currentPage, int numPerPage,int totalRow,String storeId,String startDate, String endDate,int rank);
	 ...
	 */
	public List<Map<String,Object>> getOutTimeDayTopByStore(String storeId,String startDate, String endDate,int rank);
