...
@Entity
@Table(name="T_STU_SCORE_RESULT_DEPT")
public class TStuScoreResultDept implements Serializable{
	...
	public TStuScoreResultDept() {
		super();
	}
	
	public TStuScoreResultDept(String id, String dept_id, String school_year, String term_code, Double gpa_avg, Double gpa_middle,
	...
	public TStuScoreResultDept( String dept_id, String school_year, String term_code, Double gpa_avg, Double gpa_middle,
			Double gpa_mode,Double gpa_fc,Double gpa_bzc,Double better,Double fail,Double rebuild,Double under,Double score_avg,
			Double score_middle,Double score_mode,Double score_fc,Double score_bzc,Double gpa_before,int smart_count,Double smart_scale) {
		super();
		this.dept_id = dept_id;
