...
<link rel="stylesheet" href="${ctxStatic }/bootstrap-3.3.4-dist/css/bootstrap-datetimepicker.min.css">
...
<script type="text/javascript" src="${ctxStatic }/js/common/dateFormat.js"></script>
<script type="text/javascript" src="${ctxStatic }/js/common/startEndDate.js"></script>