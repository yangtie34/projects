...
public class CSS {
     ...
     * 样式
     */
    public static class RelativeLayoutParams {
        ...
        public static RelativeLayout.LayoutParams widthHeight(int width,int height){
            return new RelativeLayout.LayoutParams
                    (width,height);
        }
    }
     ...
     * 样式
     */
    public static class LinearLayoutParams {
        public static LinearLayout.LayoutParams wrapAll() {
            return new LinearLayout.LayoutParams
                    (ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        }

        public static LinearLayout.LayoutParams matchAll() {
            return new LinearLayout.LayoutParams
                    (ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        }

        public static LinearLayout.LayoutParams wrapWidth() {
            return new LinearLayout.LayoutParams
                    (ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT);
        }

        public static LinearLayout.LayoutParams wrapHeight() {
            return new LinearLayout.LayoutParams
                    (ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        }

        public static LinearLayout.LayoutParams widthHeight(int width, int height) {
            return new LinearLayout.LayoutParams
                    (width, height);
        }
    }
