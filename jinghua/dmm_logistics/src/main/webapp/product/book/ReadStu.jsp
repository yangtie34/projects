...
<meta charset="UTF-8">
<title>学生图书借阅分析</title>
</head>
<body ng-controller="BookReadStuController">
<div id="wrapper">
<%-- <jsp:include page="../../product/left.jsp"></jsp:include> --%>
 <script type="text/javascript" src="${ctx }/product/book/js/ReadStu.js"></script>    
            ...
            <div class="content_main">
             ...
             <!--    	<div class="top_date">
               ...
               <!--------------------------------------------------- 以上为books-top-imges内容------------------------------------------------>
                ...
                <div class="guoqi">
                	<div class="t">
            			<h5>分{{deptlname}}分析学生借阅情况</h5>
                	</div>
                	                    <div class="danxuan">
                        <div class="radio radio-inline radio-change radio-blue">
                            <input type="radio"  id="liut7" value="0" checked=""ng-model="radio7id">
                            <label for="liut7" class="fw-nm">
                             借书数
                            </label>
                        </div>
                        <div class="radio radio-inline radio-change radio-blue">
                            <input type="radio"  id="ltl7" value="1"ng-model="radio7id">
                            <label for="ltl7" class="fw-nm">
                              人均借书数
                            </label>
                        </div>
                    </div>
                    <div>
                    	...
                    	<div stu-chart config="radio7data" style="height:310px;"class="img-top"> </div>
