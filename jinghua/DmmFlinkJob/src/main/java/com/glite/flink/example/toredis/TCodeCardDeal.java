...
public class TCodeCardDeal {
	...
	public TCodeCardDeal(){
    	super();
    }
    public TCodeCardDeal(String values){
	...
	public static JDBCInputFormat createInputFormat() {
		...
		JDBCInputFormat jdbcInputFormat = JDBCInputFormat
				...
				.setPassword("dm")
				.setQuery(
						"select ID,CODE_,NAME_,PID,PATH_,LEVEL_,LEVEL_TYPE,ISTRUE,ORDER_  from T_CODE_CARD_DEAL")
	...
	public static void main(String[] args) throws Throwable  {
		...
		DataSet<Tuple2<String, String>> dataSet=datasource.flatMap(new FlatMapFunction<Row, TCodeCardDeal>() {
			@Override
			public void flatMap(Row value, Collector<TCodeCardDeal> out) throws Exception {
				// TODO Auto-generated method stub
				
				out.collect(new TCodeCardDeal(value.toString()));	
			}
		}).flatMap(new FlatMapFunction<TCodeCardDeal, Tuple2<String,String>>() {
			@Override
			public void flatMap(TCodeCardDeal value, Collector<Tuple2<String, String>> out) throws Exception {
				// TODO Auto-generated method stub
		...
		dataSet.output(new RedisOutPutFormat(jedisPoolConfig, new RedisHsetMapper("T_CODE_CARD_DEAL")));
				env.execute();
