...
@Controller
@RequestMapping("pmsFeeRemission")
public class FeeRemissionPmsCtol {
	...
	public Map<String, Object> getStuDetail(String param, String page, String values, String fields){
		return feeRemissionService.getStuDetail(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
...
//		response.setContentType("application/x-execl"); 
		...
		List<Map<String, Object>> list = feeRemissionService.getStuDetailAll(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
