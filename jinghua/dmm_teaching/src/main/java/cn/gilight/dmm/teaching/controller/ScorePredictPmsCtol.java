 ...
 */
@Controller
@RequestMapping("pmsScorePredict")
public class ScorePredictPmsCtol {
	@Resource
	...
	public Map<String, Object> getStuDetail(String param, String page, String values, String fields){
		return scorePredictService.getTeaDetail(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
...
//		response.setContentType("application/x-execl"); 
		...
		List<Map<String, Object>> list = scorePredictService.getStuDetailAll(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
