 ...
 */
@Controller
@RequestMapping("pmsFeeWarning")
public class FeeWarningPmsCtol {
	...
	public Map<String, Object> getStuDetail(String param, String page, String values, String fields){
		return feeWarningService.getTeaDetail(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
...
//		response.setContentType("application/x-execl"); 
		...
		List<Map<String, Object>> list = feeWarningService.getStuDetailAll(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
