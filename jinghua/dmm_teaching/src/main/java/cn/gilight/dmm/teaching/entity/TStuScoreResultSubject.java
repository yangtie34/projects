...
@Entity
@Table(name="T_STU_SCORE_RESULT_SUBJECT")
public class TStuScoreResultSubject implements Serializable{
	...
	private String id;
	private String subject_degree_id;
	...
	public TStuScoreResultSubject() {
		super();
	}
	
	public TStuScoreResultSubject(String id, String subject_degree_id, String school_year, String term_code, Double gpa_avg, Double gpa_middle,
		...
		super();
		this.id = id;
		this.subject_degree_id = subject_degree_id;
	...
	public TStuScoreResultSubject( String subject_degree_id, String school_year, String term_code, Double gpa_avg, Double gpa_middle,
			Double gpa_mode,Double gpa_fc,Double gpa_bzc,Double better,Double fail,Double rebuild,Double under,Double score_avg,
			Double score_middle,Double score_mode,Double score_fc,Double score_bzc,Double gpa_before,int smart_count,Double smart_scale) {
		super();
		this.subject_degree_id = subject_degree_id;
	...
	@Column(name = "SUBJECT_DEGREE_ID", length = 20)
	public String getSubject_degree_id() {
		return subject_degree_id;
	}
	public void setSubject_degree_id(String subject_degree_id) {
		this.subject_degree_id = subject_degree_id;
	}
