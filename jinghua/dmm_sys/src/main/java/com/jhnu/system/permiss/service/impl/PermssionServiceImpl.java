...
public class PermssionServiceImpl implements PermssionService{
	...
	@Override
	public ResultBean addPermssionsAjax(Map<String, Object> map,List<Map> list) {
	...
	public List<Map<String,String>> getIdsList(List l){
	...
	@Override
	public ResultBean addPermssionAjax(Map<String, Object> map) {
		ResultBean rb = new ResultBean();
		...
		List jgIds=null;
		if(map.get("jgIds")!=null)
		 jgIds=getIdsList((List) map.get("jgIds"));
	...
	public ResultBean deleteRolePermssion(Long rolePermssionId) {
		...
		deptPermissionService.resetRoleDept(rolePermssionId, list);
		deptPermissionService.resetRoleDeptTeach(rolePermssionId, list);
		rb.setTrue(true);
		return rb;
	}
	...
	public ResultBean deleteUserPermssion(Long userPermssionId) {
		...
		deptPermissionService.resetUserDept(userPermssionId, list);
		deptPermissionService.resetUserDeptTeach(userPermssionId, list);
		rb.setTrue(true);
		return rb;
	}
	...
	@Override
	public ResultBean resetZzOrJxjg(Map<String, Object> map) {
		ResultBean rb = new ResultBean();
		String peopleType=MapUtils.getString(map, "peopleType");
		String jgType=MapUtils.getString(map, "jgType");
		Long permId=MapUtils.getLong(map, "permId");
		//String jgIds=MapUtils.getString(map, "jgIds");
		List jgIds=getIdsList((List) map.get("jgIds"));
		rb.setTrue(false);
		rb.setName("更新失败");
		if("role".equals(peopleType)){
			if("jxjg".equals(jgType)){
				deptPermissionService.resetRoleDeptTeach(permId, jgIds);
				rb.setTrue(true);
			}else if("zzjg".equals(jgType)){
				deptPermissionService.resetRoleDept(permId, jgIds);
				rb.setTrue(true);
			}
		}else if("user".equals(peopleType)){
			if("jxjg".equals(jgType)){
				deptPermissionService.resetUserDeptTeach(permId, jgIds);
				rb.setTrue(true);
			}else if("zzjg".equals(jgType)){
				deptPermissionService.resetUserDept(permId, jgIds);
				rb.setTrue(true);
			}
		}
		return rb;
