...
(function ($) {
  ...
  var WorldMap = function (params) {
    ...
    for (var key in mapData.pathes) {
      ...
      var text = this.canvas.createText({
        name:mapData.pathes[key].name,
        x:mapData.pathes[key].x,
        y:mapData.pathes[key].y,
        style:'font-size:10px;line-height:100%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans;z-index:5'
      });
