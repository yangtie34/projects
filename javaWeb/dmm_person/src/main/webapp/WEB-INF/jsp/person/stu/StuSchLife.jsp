  ...
  <div class="container">
    <section class="jiaozhi-first-list" ng-repeat="(key,value) in vm.items[6]" >
       ...
       <div class="media" ng-show="key=='jy'">
         ...
         <div class="media-body media-middle"><h4 class="jiaozhi-inline-block ">{{value[0].TIME_}} </h4><p class="jiaozhi-inline-block">进行了在矿大的首次图书馆借阅，本次借阅内容为《{{value[0].NAME_}}》。</p></div>
       </div>
