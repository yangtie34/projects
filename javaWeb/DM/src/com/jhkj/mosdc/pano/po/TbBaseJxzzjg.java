...
/**
 * TbBaseJxzzjg generated by hbm2java
 */
@Entity
@Table(name = "TB_BASE_JXZZJG", schema = "MOSDC_PANO")
public class TbBaseJxzzjg implements java.io.Serializable {
	...
	public TbBaseJxzzjg(long id, String mc) {
		this.id = id;
		this.mc = mc;
	}

	public TbBaseJxzzjg(long id, String dm, String mc, Long fjdId, Long cc,
			String cclx, Boolean sfyzjd, Boolean sfky, String xxdm, String qxm,
			Short pxh, String jdbb, Boolean jdbs, String sjtbsj, String tbfs) {
		this.id = id;
		this.dm = dm;
		this.mc = mc;
		this.fjdId = fjdId;
