...
public class UpdateManager {
    ...
    //返回的安装包url
    private String apkUrl = "http://update.eyunsoft.cn/App_WasteOil/";

    //更新文件
    private String fileName="com.eyunsoft.app.app_wasteoil.apk";

    //返回的更新提示
    private String apkXml="http://update.eyunsoft.cn/App_WasteOil/UpdateInfo.xml";
    ...
    private static final String saveFileName = savePath + "com.eyunsoft.app.app_wasteoil.apk";
