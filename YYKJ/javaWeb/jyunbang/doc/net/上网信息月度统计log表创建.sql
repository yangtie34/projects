...
select to_date('2013-09', 'yyyy-mm') year_month,
 ...
 where 1 = 1
   and substr(t.on_time, 0, 7) = '2011-12' and s.no_ is not null
 group by TH.HOUR_,
          s.sex_code,
          tc.name_,
          s.dept_id,
...
drop table tl_net_type_month;
create table tl_net_type_month ( 
  YEAR_MONTH      date,			--年月
  HOUR_           VARCHAR2(100),--时段，
  ON_COUNTS		  VARCHAR2(100),--登陆次数
  OUT_COUNTS	  VARCHAR2(100),--退出次数
  IN_COUNTS	      VARCHAR2(100),--在线人次
  USE_TIME		  VARCHAR2(100),--使用时间
  USE_FLOW	  	  VARCHAR2(100),--使用流量
  USE_MONEY	      VARCHAR2(100),--使用金额
  DEPT_ID      	  VARCHAR2(100),
  DEPT_NAME       VARCHAR2(100),--学院，
  MAJOR_ID        VARCHAR2(100),
  MAJOR_NAME      VARCHAR2(100),--专业
  CLASS_ID        VARCHAR2(100),
  CLASS_NAME      VARCHAR2(100),--班级
  SEX_CODE        VARCHAR2(100),
  SEX_NAME        VARCHAR2(100),--性别
  EDU_ID          VARCHAR2(100),
  EDU_NAME        VARCHAR2(100),--学历
  NATION_CODE	  VARCHAR2(100),
  NATION_NAME	  VARCHAR2(100),--民族
  ON_TYPE_CODE	  VARCHAR2(100),--登陆方式
  ON_TYPE_NAME	  VARCHAR2(100)--登陆方式名称
