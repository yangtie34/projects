...
public final class ServerConfig {
    ...
    public static class Update {
        //返回的安装包url
        public static final String APK_URL = "http://update.eyunsoft.cn/App_WasteOil/";

        //更新文件
        public static final String FILE_APK_NAME = "com.eyunsoft.app.app_wasteoil.apk";

        //返回的更新提示
        public static final String APK_XML = "http://update.eyunsoft.cn/App_WasteOil/UpdateInfo.xml";
        /* 下载包安装路径 */
        public static final String PATH_SAVE = "/sdcard/updatedemo/";

        public static final String FILE_SAVE = PATH_SAVE + "com.eyunsoft.app.app_wasteoil.apk";
    }
    ...
    public static class JDBC {
        ...
        public static  String orcl="XiangGuoHe_Test";
        public static  String url = "jdbc:jtds:sqlserver://"+ipAndPort+"/"+orcl+";loginTimeout=30;socketTimeout=30";//"jdbc:sqlserver://192.168.56.248:1533;DatabaseName=HuaChi_Test";//"jdbc:oracle:thin:@ 202.196.0.180:1521:DM";
        public static  String user = "xiangguohebs";
        public static  String password = "xiangguohebs20170217";
        //验证数据库连接是否健康
