 ...
 */
@Controller
@RequestMapping("pmsStudentLoans")
public class StudentLoansPmsCtol {
	...
	public Map<String, Object> getStuDetail(String param, String page, String values, String fields){
		return studentLoansService.getStuDetail(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
...
//		response.setContentType("application/x-execl"); 
		...
		List<Map<String, Object>> list = studentLoansService.getStuDetailAll(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
