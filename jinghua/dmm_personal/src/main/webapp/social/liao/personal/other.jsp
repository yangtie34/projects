...
<base href="<%=root%>/social/liao/personal/other.jsp"/>
...
<body ng-controller="controller" class="rxs-bg">
		<input type="text" hidden="hidden" id="um" value="${username }"/>
			<input type="text" hidden="hidden" id="um" value="${username }"/>
				<div class="rxs-menu-top rxs-bg-f4 text-center"> <img class="img-circle" width="85" ng-src="{{personalInfo.wechat_head_img}}">
