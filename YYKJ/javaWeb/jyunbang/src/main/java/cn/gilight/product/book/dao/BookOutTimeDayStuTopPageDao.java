 ...
 *
 */
public interface BookOutTimeDayStuTopPageDao {
	/**
	 * 获取根据人员ID获取所有逾期还书列表
	 * @param currentPage
	 * @param numPerPage
	 ...
	 * @param storeId
	 * @return
	 * rank_,outtime_day,stu_id,user_name,DEPT_ID,DEPT_NAME,MAJOR_ID,MAJOR_NAME,CLASS_ID,CLASS_NAME,EDU_ID,EDU_NAME,SEX_CODE,SEX_NAME,GRADE,GRADE_NAME <br>
