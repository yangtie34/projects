...
public class JobCardDaoImpl implements JobCardDao {
	...
	public Map<String, Integer> updateCardTrend() {
		...
		sql="insert into TL_CARD_TREND                                                                                    "+
				...
				"'' USE_PEOPLE,'' all_people,'' HOUR_ from tl_card_pay_stu_month t                                            "+
				"group by t.year_month,t.card_deal_id, t.card_deal_name ,t.dept_id,t.major_id";
		addNum+=baseDao.getJdbcTemplate().update(sql);
		sql="insert into TL_CARD_TREND                                                                                    "+
				"select a.year_month,a.dept_id,a.major_id,'all' type_code,'总体' type_name,'pay_all' flag,a.all_money,              "+
				"a.all_count,b.nums use_people,'' all_people,'' HOUR_ from                                                    "+
		...
		addNum+=baseDao.getJdbcTemplate().update(sql);
		sql="insert into TL_CARD_TREND                                                                                    "+
				"select a.year_month,a.dept_id,a.major_id,a.type_code,a.type_name,'pay_sex' flag,a.all_money,                       "+
				"a.all_count,b.nums use_people,'' all_people,'' HOUR_ from                                                    "+
				"(select sum(t.pay_money) all_money ,sum(t.pay_count) all_count,t.year_month,t.dept_id,t.major_id ,           "+
		...
		addNum+=baseDao.getJdbcTemplate().update(sql);
		sql="insert into TL_CARD_TREND                                                                                    "+
				"select a.year_month,a.dept_id,a.major_id,a.type_code,a.type_name,'pay_edu' flag,a.all_money,                       "+
				"a.all_count,b.nums use_people,'' all_people,'' HOUR_ from                                                    "+
				"(select sum(t.pay_money) all_money ,sum(t.pay_count) all_count,t.year_month,t.dept_id,t.major_id ,           "+
		...
		sql="insert into TL_CARD_TREND                                                                                    "+
				...
				"flag,sum(t.pay_money) all_money,sum(t.pay_count) all_count,'' use_people,'' all_people,t.hour_               "+
				"from tl_card_pay_stu_month t where t.card_deal_id='"+Code.getKey("card.ct")+"'                                                      "+
		...
		sql="insert into TL_CARD_TREND                                                                                    "+
				...
				"flag,sum(t.pay_money) all_money,sum(t.pay_count) all_count,                                                  "+
