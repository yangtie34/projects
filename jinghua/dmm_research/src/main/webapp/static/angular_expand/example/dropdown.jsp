...
<script type="text/javascript" src="../pc/ng-system.js"></script> 
</head>
<body ng-controller="controller">
<div btn-dropdown source="source" on-change="change($data)" btn-class="btn-success btn-sm" btn-style="background-color:#FFF; color:#222;" display-field="mc"></div>
<br /> 
<div btn-dropdown source="source" on-change="change($data)" btn-class="btn-success btn-xs noradius" btn-style="background-color:#FFF; color:#222;" display-field="mc"></div>
无圆角<br /> 
<br /> 
