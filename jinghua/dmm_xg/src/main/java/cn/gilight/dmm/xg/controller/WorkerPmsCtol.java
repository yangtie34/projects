 ...
 */
@Controller
@RequestMapping("pmsWorker")
public class WorkerPmsCtol {
	...
	public Map<String, Object> getTeaDetail(String param, String page, String values, String fields) {
		return workerService.getTeaDetail(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), JSONObject.parseObject(values, HashMap.class), JSONObject.parseArray(fields, String.class));
	}
...
//		response.setContentType("application/x-execl"); 
		...
		List<Map<String, Object>> list = workerService.getTeaDetailList(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
