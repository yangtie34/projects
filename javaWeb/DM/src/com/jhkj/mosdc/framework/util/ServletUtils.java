...
public class ServletUtils {
	...
	/**
     * 从实体配置文件entity.xml中获取当前实体的包名和实体具体名称
     * @param entityName
     * @return
     */
    @SuppressWarnings("unchecked")
	public static String entityPath (String entityName){
    	try{
	    	ActionContext act = ActionContext.getContext();
	        Map requestMap = (HashMap) act.getApplication().get(SysConstants.request_entitys);
	        Map entityMap = (Map) requestMap.get(entityName);
			...
			classz=(Class)m.invoke(service, entityName);			
