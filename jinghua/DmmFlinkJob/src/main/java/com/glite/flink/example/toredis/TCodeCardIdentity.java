...
public class TCodeCardIdentity {
	private String id;
	...
	public static JDBCInputFormat createInputFormat() {
		TypeInformation<?>[] fieldTypes = new TypeInformation<?>[] {
				...
				BasicTypeInfo.INT_TYPE_INFO,BasicTypeInfo.STRING_TYPE_INFO,BasicTypeInfo.INT_TYPE_INFO,
		...
		JDBCInputFormat jdbcInputFormat = JDBCInputFormat
				...
				.setPassword("dm")
				.setQuery(
						"select ID,CODE_,NAME_,PID,PATH_,LEVEL_,LEVEL_TYPE,ISTRUE,ORDER_ from T_CODE_CARD_IDENTITY")
	...
	public static void main(String[] args) throws Throwable  {
		...
		DataSet<Tuple2<String, String>> dataSet=datasource.flatMap(new FlatMapFunction<Row, TCodeCardIdentity>() {
			@Override
			public void flatMap(Row value, Collector<TCodeCardIdentity> out) throws Exception {
				// TODO Auto-generated method stub
				
				out.collect(new TCodeCardIdentity(value.toString()));	
			}
		}).flatMap(new FlatMapFunction<TCodeCardIdentity, Tuple2<String,String>>() {
			@Override
			public void flatMap(TCodeCardIdentity value, Collector<Tuple2<String, String>> out) throws Exception {
				// TODO Auto-generated method stub
		...
		dataSet.output(new RedisOutPutFormat(jedisPoolConfig, new RedisHsetMapper("T_CODE_CARD_IDENTITY")));
				env.execute();
	...
	public TCodeCardIdentity(){
    	super();
    }
    public TCodeCardIdentity(String values){
