 ...
 * HttpUtils
 * <ul>
 * <strong>Http get, you can also use {@linkHttpCache}</strong>
...
public class HttpUtils {
     ...
     * <li>If you want get data synchronous, use {@linkHttpCache#httpGet(HttpRequest)} or
     * {@linkHttpCache#httpGetString(HttpRequest)}</li>
     * </ul>
     * 
     * @param request
     * @param listener listener which can do something before or after HttpGet. this can be null if you not want to do
