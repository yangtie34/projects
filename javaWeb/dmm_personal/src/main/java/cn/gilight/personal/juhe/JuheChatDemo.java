...
public class JuheChatDemo {
   ...
   //配置您申请的KEY
     public static final String APPKEY ="3b5b213a6a3d37d557e7285c8c9384c7";
  
     //1.问答
     public static Map<String,Object> getRequest1(String info){
         ...
         try {
             ...
             if(object.getIntValue("error_code")==0){
                 Map m = (Map) object.get("result");
                 map.put("text", m.get("text"));
             }else{
                 map.put("text", object.get("reason"));
             }
         } catch (Exception e) {
             e.printStackTrace();
         }
