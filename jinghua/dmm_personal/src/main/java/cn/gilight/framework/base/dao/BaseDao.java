...
public interface BaseDao {
	...
	/* 使用prepareStatement来传递参数进行更新数据 */
	public abstract int[] batchUpdate(String sql, BatchPreparedStatementSetter preparedStatementSetter);
	...
	*/
	public Page queryWithPageInLowerKey(final String sql,final Page page);
}
