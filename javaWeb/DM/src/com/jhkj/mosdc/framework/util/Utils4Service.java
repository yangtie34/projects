...
public class Utils4Service {
    ...
    public static Map packageParams(String params){
        ...
        int start = paramObj.containsKey("start")?paramObj.getInt("start"):0;
        int limit = paramObj.containsKey("limit")?paramObj.getInt("limit"):25;
    ...
    public static String packageJsonStr(Map map){
        ...
        String resultStr ="{success:true,\"data\":" + Struts2Utils.mapInList2Json(list)
                + " ,\"count\":\"" + map.get("count") + "\"}";
        return resultStr;
    }
    /**
