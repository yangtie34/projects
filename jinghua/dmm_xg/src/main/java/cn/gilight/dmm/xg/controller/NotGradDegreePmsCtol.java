...
@Controller
@RequestMapping("pmsNotGradDegree")
public class NotGradDegreePmsCtol {
	@Resource
	...
	public Map<String, Object> getStuDetail(String param, String page, String values, String fields){
		return notGradDegreeService.getTeaDetail(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
...
//		response.setContentType("application/x-execl"); 
		...
		List<Map<String, Object>> list = notGradDegreeService.getStuDetailAll(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page), 
