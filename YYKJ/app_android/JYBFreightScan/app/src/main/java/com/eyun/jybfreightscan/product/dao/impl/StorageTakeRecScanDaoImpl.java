...
import com.eyun.jybfreightscan.product.dao.StorageTakeRecScanDao;
import com.eyun.jybfreightscan.product.entity.StorageTakeRec;
import com.eyun.jybfreightscan.product.entity.StorageTakeRecScan;
...
public class StorageTakeRecScanDaoImpl implements StorageTakeRecScanDao {
    ...
    public List<StorageTakeRecScan> getStorageTakeRecScans(String RecNumber, int ScanType) {
        String sqlSelect="Select * from StorageTakeRecScan where RecNumber="+ SqlStringUtils.GetQuotedString(RecNumber)
    ...
    public boolean isExist(StorageTakeRecScan mo) {
        String sqlSelect="Select ScanNumber from StorageTakeRecScan where RecNumber="+ SqlStringUtils.GetQuotedString(mo.getRecNumber())
                +" and ProID="+mo.getProId()+" and ScanType="+mo.getScanType();
