...
public class SwipeDropDownListView extends DropDownListView {
    ...
    public SwipeDropDownListView(Context context) {
        this(context,null);
    }

    public SwipeDropDownListView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SwipeDropDownListView(Context context, AttributeSet attrs, int defStyle) {
