...
<script type="text/javascript" src="${ctxStatic}/product/four/card/js/index.js"></script>
<script type="text/javascript" src="${ctxStatic}/product/four/card/js/controller.js"></script>
<script type="text/javascript" src="${ctxStatic}/product/four/card/js/service.js"></script>
...
<div class="sub-content">
  <table class="sub-table" width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
        <th  width="17%" class="sub-btm-none" >消费时间</th> 
        <th  width="17%" class="sub-btm-none" >消费类型</th>
        <th  width="17%" class="sub-btm-none" >消费地点</th>
        <th  width="17%" class="sub-btm-none" >消费金额</th>
    </tr>
    <tr ng-repeat="item in vm.items">
    <td width="17%" > {{item.TIME_}} </td>
	<td width="17%" > {{item.CARD_DEAL_NAME}} </td>
	<td width="17%" > {{item.DEPT_NAME}} 	</td>
	<td width="17%" > {{item.MONEY}} </td>
    </tr>
  </table>
<!-- 内容布局结束 -->
