...
public final class ServerConfig {
    ...
    public static class Update {
        //返回的安装包url
        public static final String APK_URL = "http://update.eyunsoft.cn/jybStorageScan/";

        //更新文件
        public static final String FILE_APK_NAME = "com.eyunsoft.app.jybStorageScan.apk";

        //返回的更新提示
        public static final String APK_XML = "http://update.eyunsoft.cn/jybStorageScan/UpdateInfo.xml";
        /* 下载包安装路径 */
        public static final String PATH_SAVE = "/sdcard/updatedemo/";

        public static final String FILE_SAVE = PATH_SAVE + "com.eyun.jybStorageScan.apk";
    }
    ...
    public static class JDBC {
        ...
        public static  String orcl="Eyun_Storage_Test";
        ...
        public static  String user = "eyun_storage";
        public static  String password = "eyun_storage@)!*)#@*20170505";
        //验证数据库连接是否健康
