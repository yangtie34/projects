...
public class DropDownListView extends ListView implements OnScrollListener {
    ...
    private void initDropDownStyle() {
        ...
        headerLayout = (RelativeLayout)inflater.inflate(R.layout.base_drop_down_list_header, this, false);
    ...
    private void initOnBottomStyle() {
        ...
        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        footerLayout = (RelativeLayout)inflater.inflate(R.layout.base_drop_down_list_footer, this, false);
