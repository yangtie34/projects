...
import com.eyun.eyunstorage.product.dao.StorageOutRecDetailDao;
    ...
    public boolean initStorageOutRecDetail(String RecNumber) {
            String sql="insert into storage_StorageOutRecDetail(" +
                   ...
                   // "ProBarCode," +
                    ...
                    "t.proId," +
                   // "pro.ProBarCode," +
                    "pro.proName,pro.ProCategory,pc.name ProCategoryName," +
                    " pro.ProSpec,ps.SpecName ProSpecName,pro.ProMeasureUnitName,sum(t.ProNumber) ProNumber" +
                    ...
                    " pro.ProSpec,ps.SpecName,pro.ProMeasureUnitName";
