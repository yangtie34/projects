 ...
 *
 */
public interface BookOutTimeNumBookTopDao {
	 ...
	 */
	public Page getOutTimeNumTopByBook(int currentPage, int numPerPage,int totalRow,String storeId,String startDate, String endDate,int rank);
	 ...
	 */
	public List<Map<String,Object>> getOutTimeNumTopByStore(String storeId,String startDate, String endDate,int rank);
