package com.yiyun.framework.moduleview.widget;
...
public class WheelView extends View {
	...
	private int centerDrawableBg=R.drawable.wheel_center_bg;
	private int wheelViewBg=R.drawable.wheel_bg;
	/**
	 * Constructor
	 */
	...
	public WheelView(Context context,int centerDrawableBg,int wheelViewBg) {
		super(context);
		this.centerDrawableBg=centerDrawableBg;
		this.wheelViewBg=wheelViewBg;
		initData(context);
	}
	/**
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(centerDrawableBg);
		}
		...
		setBackgroundResource(wheelViewBg);
	}
