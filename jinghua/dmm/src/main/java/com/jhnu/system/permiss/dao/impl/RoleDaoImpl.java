...
public class RoleDaoImpl implements RoleDao {
    ...
    public Role createRole(final Role Role) {
        ...
        baseDao.getBaseDao().getJdbcTemplate().update(SQL, new Object[]{ID,Role.getName_(),Role.getDescription(),Role.getIstrue(),Role.getRole_type()});
        Role.setId(ID);
        return Role;
    }
	...
	public void updateRole(Role role) {
		if(role != null){
			...
			baseDao.getBaseDao().getJdbcTemplate().update(sql, new Object[]{role.getName_(),role.getDescription(),role.getIstrue(),role.getRole_type(),role.getId()});
		}
	}
