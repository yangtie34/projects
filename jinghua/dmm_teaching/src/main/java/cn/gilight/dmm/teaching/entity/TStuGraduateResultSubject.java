...
@Entity
@Table(name="T_STU_GRADUATE_RESULT_SUBJECT")
public class TStuGraduateResultSubject implements Serializable{
	/**
	 * 
	 */
	...
	public TStuGraduateResultSubject() {
		super();
	}
	
	public TStuGraduateResultSubject(String id, String subject_id, String school_year, int sum_count, int rel_count, Double graduation_scale,
	...
	public TStuGraduateResultSubject( String subject_id, String school_year, int sum_count, int rel_count, Double graduation_scale,
			Double last_graduation_scale,int degree_count,Double degree_scale,Double last_degree_scale) {
		super();
		this.subject_id = subject_id;
		this.school_year = school_year;
