 ...
 */
@Entity
@Table(name="T_STU_SCOREPRED_TERM")
public class TStuScorepredTerm {
	...
	public TStuScorepredTerm() {
	}
	
	public TStuScorepredTerm(String id, String stuId, String schoolYear, String termCode, Integer grade,
