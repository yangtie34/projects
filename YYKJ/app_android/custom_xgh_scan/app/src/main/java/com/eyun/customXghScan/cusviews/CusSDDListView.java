package com.eyun.customXghScan.cusviews;
...
public class CusSDDListView extends AngularViewParent {
    ...
    private List<View> getViews(List<Map<String,String>> list){
    ...
    public void  initListData(){
        initPageInfo();
        scope.forThread(new CallBack<List<Map<String,String>>>() {
            @Override
            public List<Map<String,String>> run() {
                return queryForList.query(queryForList.getCondition(),currentPage,numPerPage);
            }
        }, new DataListener<List<Map<String,String>>>() {
            @Override
            public void hasChange(List<Map<String, String>> l) {
                setData(l);
    ...
    private void setData(List<Map<String,String>> listData){
...
//        swipeDropDownListView.setAdapter(swipeDropDownAdapter);
    ...
    private void addData(List<Map<String,String>> listData){
        if(listData.size()<numPerPage){
            swipeDropDownListView.setHasMore(false);
        }else{
            swipeDropDownListView.setHasMore(true);
    ...
    public interface QueryForList{
         ...
         * @return
         */
        List<Map<String,String>> query(String Condition, int currentPage, int numPerPage);
         ...
         * @return
         */
        View data2view(Map<String,String> map);
...
/*    public void removeView(int index){
    ...
    //设置下拉的处理事件
    public void setOnDropDownListener(){
        //允许使用下拉样式
