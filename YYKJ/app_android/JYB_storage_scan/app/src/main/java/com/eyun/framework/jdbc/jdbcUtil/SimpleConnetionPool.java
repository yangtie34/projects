...
public class SimpleConnetionPool {
	...
	public static void initDriver() {
		...
		// load mysql driver
		try {
			driver = (Driver) Class.forName(m_driver).newInstance();
		 ...
		 * installDriver(driver); } catch (Exception e) { }
		 */
	}
	...
	public static synchronized Connection getConnection() {
		if(m_usedUsedConnection.size()>maxpool){
			m_usedUsedConnection.clear();
		}
		clearClosedConnection();
		//System.out.println("m_notUsedConnection:"+m_notUsedConnection.size());
		//System.out.println("m_usedUsedConnection:"+m_usedUsedConnection.size());
	...
	public static String getM_driver() {
		return m_driver;
	}

	public static void setM_driver(String m_driver) {
		SimpleConnetionPool.m_driver = m_driver;
	}
