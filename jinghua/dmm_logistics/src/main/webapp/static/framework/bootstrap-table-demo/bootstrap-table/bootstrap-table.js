...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            ...
            return sprintf('当前查询：第%s页，共%s条数据 ，每页', pageTo/(pageTo+1-pageFrom), totalRows);
        },
            ...
            '<div class="bootstrap-table">',
                ...
                '<div class="fixed-table-container">',
                    ...
                    '<div class="fixed-table-body">',
                        ...
                        '</div>',
                    '</div>',
                    '<div class="fixed-table-pagination xscz-ft-14"></div>',
                '</div>',
            '</div>'].join(''));
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-default" type="button" name="refresh" title="%s" style="display: none;">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open %s" title="%s">',
                ...
                '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" title="选择列">',
                '<i class="glyphicon glyphicon-th icon-th" style="float: left;"></i>',
                ' <span class="caret" style="margin-top: 6;margin-left: 2;float: right;"></span>',
                '</button>',
        ...
        if (this.options.search) {
            ...
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search">',
                    sprintf('<input class="form-control" style="height:28px"type="text" placeholder="%s">',
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (this.pageTo > this.options.totalRows) {
            this.pageTo = this.options.totalRows;
					...
					if(this.pageTo==this.options.totalRows&&this.options.pageSize<30){
        ...
        var pageNumber = [
            ...
            '<button type="button" class="btn btn-default dropdown-toggle" style="padding: 2 5 0 5;"data-toggle="dropdown">',
        ...
        this.$body.find('> tr > td').off('click').on('click', function () {
            ...
            if (that.options.clickToSelect) {
                if (that.header.clickToSelects[$tr.children().index($(this))]) {
                	var temp_colums=$tr.find(sprintf('[name="%s"]',that.options.selectItemName));
                 	if(temp_colums.length>0){
                 	   temp_colums[0].click(); // #144: .trigger('click') bug
                 	} 
                }
            }
        });
