...
public class CircleActivityCus extends AppCompatActivity {
    ...
    private int[] mItemImgs = new int[]{R.drawable.prod,
           R.drawable.report,
           // R.drawable.qiangdan,R.drawable.dis,
            R.drawable.notice, R.drawable.set};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CircleActivityCus.this.registerReceiver(receiver, filter);
        ...
        recStatus.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (!isChecked)//
                {
                    PollingUtils.stopPollingService(CircleActivityCus.this, PollingService.class, PollingService.ACTION);
                    isRunning = false;
                } else {
                    PollingUtils.startPollingService(CircleActivityCus.this, 5, PollingService.class, PollingService.ACTION);
                    isRunning = true;
                }
            }
        });
        ...
        mCircleMenuLayout.setOnMenuItemClickListener(new CircleMenuLayout.OnMenuItemClickListener() {
            ...
            public void itemClick(View view, int pos) {
                if (!NetWork.isNetworkAvailable(CircleActivityCus.this)) {
                    MsgBox.Show(CircleActivityCus.this, "网络不可用，请稍后再试");
                    return;
                }

                switch (pos) {
                    case 0:
                        Intent myIntentProd = new Intent(CircleActivityCus.this, ProdRec.class);
                        startActivity(myIntentProd);
                        break;
                    case 1:
                        Intent myIntentProdReport = new Intent(CircleActivityCus.this, ProdRecReport.class);
                        startActivity(myIntentProdReport);
                        break;
           /*         case 2:
                        Intent myIntentTransferRecstate = new Intent(CircleActivityCus.this, TransferRecstate.class);
                        startActivity(myIntentTransferRecstate);
                        break;
                    case 3:
                        Intent myIntentVehDisp = new Intent(CircleActivityCus.this, VehDisp.class);
                        startActivity(myIntentVehDisp);
                        break;*/
                    case 2:
                        Intent myIntentNoticeList = new Intent(CircleActivityCus.this, NoticeList.class);
                        startActivity(myIntentNoticeList);
                        break;
                    case 3:
//                        Intent myIntentSet = new Intent(CircleActivityCus.this, NoticeList.class);
//                        startActivity(myIntentSet);
            ...
            public void itemCenterClick(View view) {
                /*Toast.makeText(CircleActivityCus.this,
    ...
    public class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (recType == 0)//普通
            {
                ...
                Intent myIntent = new Intent(CircleActivityCus.this, NoticeDetail.class);
                myIntent.putExtra("NoticeId", noticeId);
                SendNotice(noticeId, "您有一条新的通知，点击查持详细", myIntent, msg, false, false);
            } else if (recType == 1)//转运联单
            {
                String msg = "点击查看明细!";
                Intent myIntent = new Intent(CircleActivityCus.this, TransferrecInfo.class);
            ...
            {
                String msg = "点击查看明细!";
                Intent myIntent = new Intent(CircleActivityCus.this, VehdispInfo.class);
