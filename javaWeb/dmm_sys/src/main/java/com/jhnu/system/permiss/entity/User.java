...
public class User implements Serializable {
	...
	public String getDept_teach_id() {
		return dept_teach_id;
	}

	public void setDept_teach_id(String dept_teach_id) {
		this.dept_teach_id = dept_teach_id;
	}
