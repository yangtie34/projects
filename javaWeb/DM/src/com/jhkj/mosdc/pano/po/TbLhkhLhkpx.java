...
/**
 * TbLhkhLhkpx generated by hbm2java
 */
@Entity
@Table(name = "TB_LHKH_LHKPX", schema = "MOSDC_PANO")
public class TbLhkhLhkpx implements java.io.Serializable {
	...
	public TbLhkhLhkpx(long id) {
		this.id = id;
	}

	public TbLhkhLhkpx(long id, String dm, String mc, Long fjdId, Long cc,
