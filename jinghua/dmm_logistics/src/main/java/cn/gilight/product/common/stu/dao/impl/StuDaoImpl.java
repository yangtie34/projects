package cn.gilight.product.common.stu.dao.impl;
...
public class StuDaoImpl implements StuDao {
	...
	public int getStuCByEndYear(int endYear) {
		...
		return baseDao.getJdbcTemplate().queryForObject(sql, new Object[]{endYear}, Integer.class);
	}
	...
	public int getStuCByEndYearAndSexcode(int endYear, String sexCode) {
		...
		return baseDao.getJdbcTemplate().queryForObject(sql, new Object[]{endYear,sexCode}, Integer.class);
	}
	...
	public int getStuCByEndYearAndMajor(int endYear, String majorId) {
		...
		return baseDao.getJdbcTemplate().queryForObject(sql, new Object[]{endYear,majorId}, Integer.class);
	}
	...
	public int getEndYearByStuId(String stuId) {
		...
		return baseDao.getJdbcTemplate().queryForObject(sql,new Object[]{stuId},Integer.class);
	}
	@Override
	...
	public List<Student> getStusByEndyear(int endYear) {
		...
		List<Student> stus = (List<Student>) baseDao.getJdbcTemplate().query(sql, new BeanPropertyRowMapper(Student.class), new Object[]{endYear});
		return stus;
	}
	...
	public List<Student> getStusGraduated() {
		...
		List<Student> stus = (List<Student>) baseDao.getJdbcTemplate().query(sql, new BeanPropertyRowMapper(Student.class));
		return stus;
	}
	...
	public Student getStudentInfo(String stuId) {
		...
		List<Student> stus = (List<Student>) baseDao.getJdbcTemplate().query(sql, new BeanPropertyRowMapper(Student.class), new Object[]{stuId});
	...
	public Student getStudentInfoByIdno(String stuIdNo) {
		...
		List<Student> stus = (List<Student>) baseDao.getJdbcTemplate().query(sql, new BeanPropertyRowMapper(Student.class), new Object[]{stuIdNo});
		return stus.size()==0?null:stus.get(0);
	}
	...
	public List<LateDormStudent> getLateDormStudents(LateDormStudent lds) {
		...
		List<LateDormStudent> ldsList = (List<LateDormStudent>) baseDao.getJdbcTemplate().query(sql.toString(), new BeanPropertyRowMapper<LateDormStudent>(LateDormStudent.class));
		return ldsList;
	}
	...
	public List<LateDormStudent> getLateDormStudentBytime(String startTime,String endTime,String action_date,String exe_time) {
		...
		List<LateDormStudent> ldsList = (List<LateDormStudent>) baseDao.getJdbcTemplate().query(sql, new BeanPropertyRowMapper<LateDormStudent>(LateDormStudent.class), new Object[]{action_date,exe_time,startTime,endTime});
		return ldsList;
	}
	...
	public boolean isInClassForStudent(String stuId,String classes) {
		...
		List<Map<String,Object>> list=baseDao.getJdbcTemplate().queryForList(sql,new Object[]{stuId});
