...
public class Product implements java.io.Serializable {
	...
	public Long getVestingComSuppId() {
		return vestingComSuppId;
	}
	public void setVestingComSuppId(Long vestingComSuppId) {
		this.vestingComSuppId = vestingComSuppId;
	}
