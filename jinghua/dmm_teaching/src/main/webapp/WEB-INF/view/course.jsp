...
<script type="text/javascript" src="product/course/controller.js"></script>
<script type="text/javascript" src="product/course/service.js"></script>
</head>
...
<div class="ss-mark-wrapper" >
 <div class="ss-mark-main">
        ...
        <div class="performance-change no-border no-bottom">
			  ...
			  <div class="dis-inb jx-tip">当前学期开设课程<span class="text-green jx-tip-n">{{data.abs}}</span>门，在用<span class="jx-tip-n jx-color-org">{{data.abs}}</span>门。（不包含选课信息）</div>
        </div>  
        
        <div class="performance-change" part-modal show-modal="data.courShow">
        	<div class="block-tit">
            	<p class="dis-inb">课程分布</p>
            </div>
        ...
        <div class="performance-change" part-modal show-modal="data.dept.mask">
        	<div class="block-tit">
            	<p class="dis-inb">各{{data.deptMc}}课程分布</p>
                <div class="dis-inb">
        ...
        <div class="performance-change" part-modal show-modal="data.deptHist.mask">
        	<div class="block-tit">
            	<p class="dis-inb">各{{data.deptMc}}课程发展趋势</p>
                <div class="dis-inb">
