 ...
 *
 */
NS.define('Pages.sc.TeacherSituation',{
    extend:'Template.Page',
    modelConfig: {
        serviceConfig: {
            queryYxzzjgTree: 'scService?getYxzzjgTree',// 获取导航栏数据，教学组织结构
            getXbfbByTjlb:'scTeacherService?getXbfbByTjlb',// 统计性别分布
            getMzzcByTjlb:'scTeacherService?getMzzcByTjlb',// 统计民族组成
            getCountsByTjlb:'scTeacherService?getCountsByTjlb',// 获取各学生类别人数
            getNldfbByTjlb:'scTeacherService?getNldfbByTjlb',// 年龄段
            getZzmmByTjlb:'scTeacherService?getZzmmByTjlb',// 政治面貌
            getLydByTjlb:'scTeacherService?getLydByTjlb',// 来源地
            getXwzcByTjlb:'scTeacherService?getXwzcByTjlb',
            getXlzcByTjlb:'scTeacherService?getXlzcByTjlb',
            getRyxkByTjlb:'scTeacherService?getRyxkByTjlb',
            getRyxkByTjlb2:'scTeacherService?getRyxkByTjlb2'
        }
    },
    tplRequires : [],
    cssRequires : [],
    ...
    init: function () {
        ...
        var pageTitle = new Exp.component.PageTitle({
            data:{
                pageName:'教职工基本概况统计',
                pageHelpInfo:'从性别、年龄、民族、政治面貌、学历、类别、科类等多方面分析教职工分布组成情况。'}
        });
