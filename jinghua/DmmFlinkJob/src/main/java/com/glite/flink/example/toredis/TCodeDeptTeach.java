...
public class TCodeDeptTeach {
	...
	public static JDBCInputFormat createInputFormat() {
		TypeInformation<?>[] fieldTypes = new TypeInformation<?>[] {
				...
				BasicTypeInfo.INT_TYPE_INFO,BasicTypeInfo.INT_TYPE_INFO,BasicTypeInfo.STRING_TYPE_INFO};
		...
		JDBCInputFormat jdbcInputFormat = JDBCInputFormat
				...
				.setPassword("dm")
				.setQuery(
						"select ID,CODE_,NAME_,PID,PATH_,LEVEL_,LEVEL_TYPE,ISTRUE,ORDER_,SUBJECT_ID  from T_CODE_DEPT_TEACH")
	...
	public static void main(String[] args) throws Throwable  {
		...
		DataSet<Tuple2<String, String>> dataSet=datasource.flatMap(new FlatMapFunction<Row, TCodeDeptTeach>() {
			@Override
			public void flatMap(Row value, Collector<TCodeDeptTeach> out) throws Exception {
				// TODO Auto-generated method stub
				
				out.collect(new TCodeDeptTeach(value.toString()));	
			}
		}).flatMap(new FlatMapFunction<TCodeDeptTeach, Tuple2<String,String>>() {
			@Override
			public void flatMap(TCodeDeptTeach value, Collector<Tuple2<String, String>> out) throws Exception {
				// TODO Auto-generated method stub
		...
		dataSet.output(new RedisOutPutFormat(jedisPoolConfig, new RedisHsetMapper("T_CODE_DEPT_TEACH")));
				env.execute();
			
     

	}
	public TCodeDeptTeach(String values){
		 ...
		 this.setSubject_id(vs[9]);	 
		   
	}
		 
    public TCodeDeptTeach(){
		    	super();
	}
