...
<body ng-controller="OverdueController">
	...
	<%-- 	<jsp:include page="../../product/left.jsp"></jsp:include> --%>
		<script type="text/javascript" src="${ctx }/product/book/js/Overdue.js"></script>
    <div class="content">
                    ...
                    <div class="yuqi_top_img">
                        ...
                        <div class="fl">
                            <div id="octagon" class="fl">
                                ...
                                <span tool-tip placement="top"  >
									<span>计算方式：逾期已还书籍/借书总书籍)</span>
								</span>
                                <!-- <i class="icon-info-sign" title="计算方式：逾期已还书籍/借书总书籍)"></i> --></h4></div>
                                <ul>
