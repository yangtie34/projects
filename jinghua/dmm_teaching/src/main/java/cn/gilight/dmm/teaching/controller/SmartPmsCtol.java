...
@Controller
@RequestMapping("pmsSmart")
public class SmartPmsCtol {
	@Resource
	private SmartService smartService;
	@RequestMapping("getStuList")
	@ResponseBody
	public Map<String, Object> getStuList(String param,String page, String values, String fields) {
		return smartService.getStuList(AdvancedUtil.converAdvancedList(param), PageUtils.converPage(page),JSONObject.parseObject(values, HashMap.class), JSONObject.parseArray(fields, String.class));
	}
...
//		response.setContentType("application/x-execl"); 
		...
		List<Map<String, Object>> list = smartService.getStuDetail(AdvancedUtil.converAdvancedList(param), JSONObject.parseObject(values, HashMap.class), JSONObject.parseArray(fields, String.class));
